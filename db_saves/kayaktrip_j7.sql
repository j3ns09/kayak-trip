...
--
-- Host: localhost
-- Generation Time: Aug 28, 2025 at 12:30 AM
...
INSERT INTO `accommodations` (`id`, `stop_id`, `name`, `description`, `base_price_per_night`, `stars`) VALUES
(1, 1, 'Hébergement 1 - Le Puy-en-Velay', 'Hébergement confortable situé à Le Puy-en-Velay.', 90.35, 3),
(2, 1, 'Hébergement 2 - Le Puy-en-Velay', 'Hébergement confortable situé à Le Puy-en-Velay.', 93.34, 3),
(3, 2, 'Hébergement 1 - Roanne', 'Hébergement confortable situé à Roanne.', 86.49, 3),
(4, 2, 'Hébergement 2 - Roanne', 'Hébergement confortable situé à Roanne.', 96.35, 3),
(5, 3, 'Hébergement 1 - Feurs', 'Hébergement confortable situé à Feurs.', 66.86, 3),
(6, 3, 'Hébergement 2 - Feurs', 'Hébergement confortable situé à Feurs.', 51.07, 3),
(7, 4, 'Hébergement 1 - Saint-Étienne', 'Hébergement confortable situé à Saint-Étienne.', 116.45, 3),
(8, 4, 'Hébergement 2 - Saint-Étienne', 'Hébergement confortable situé à Saint-Étienne.', 67.13, 3),
(9, 5, 'Hébergement 1 - Nevers', 'Hébergement confortable situé à Nevers.', 66.13, 3),
(10, 5, 'Hébergement 2 - Nevers', 'Hébergement confortable situé à Nevers.', 70.22, 3),
(11, 6, 'Hébergement 1 - La Charité-sur-Loire', 'Hébergement confortable situé à La Charité-sur-Loire.', 58.98, 3),
(12, 6, 'Hébergement 2 - La Charité-sur-Loire', 'Hébergement confortable situé à La Charité-sur-Loire.', 62.76, 3),
(13, 7, 'Hébergement 1 - Cosne-Cours-sur-Loire', 'Hébergement confortable situé à Cosne-Cours-sur-Loire.', 108.69, 3),
(14, 7, 'Hébergement 2 - Cosne-Cours-sur-Loire', 'Hébergement confortable situé à Cosne-Cours-sur-Loire.', 114.37, 3),
(15, 8, 'Hébergement 1 - Gien', 'Hébergement confortable situé à Gien.', 58.10, 3),
(16, 8, 'Hébergement 2 - Gien', 'Hébergement confortable situé à Gien.', 111.55, 3),
(17, 9, 'Hébergement 1 - Briare', 'Hébergement confortable situé à Briare.', 75.29, 3),
(18, 9, 'Hébergement 2 - Briare', 'Hébergement confortable situé à Briare.', 102.01, 3),
(19, 10, 'Hébergement 1 - Orléans', 'Hébergement confortable situé à Orléans.', 77.48, 3),
(20, 10, 'Hébergement 2 - Orléans', 'Hébergement confortable situé à Orléans.', 50.11, 3),
(21, 11, 'Hébergement 1 - Blois', 'Hébergement confortable situé à Blois.', 60.54, 3),
(22, 11, 'Hébergement 2 - Blois', 'Hébergement confortable situé à Blois.', 70.27, 3),
(23, 12, 'Hébergement 1 - Amboise', 'Hébergement confortable situé à Amboise.', 117.14, 3),
(24, 12, 'Hébergement 2 - Amboise', 'Hébergement confortable situé à Amboise.', 98.79, 3),
(25, 13, 'Hébergement 1 - Tours', 'Hébergement confortable situé à Tours.', 114.06, 3),
(26, 13, 'Hébergement 2 - Tours', 'Hébergement confortable situé à Tours.', 71.00, 3),
(27, 14, 'Hébergement 1 - Chinon', 'Hébergement confortable situé à Chinon.', 73.49, 3),
(28, 14, 'Hébergement 2 - Chinon', 'Hébergement confortable situé à Chinon.', 70.19, 3),
(29, 15, 'Hébergement 1 - Saumur', 'Hébergement confortable situé à Saumur.', 73.05, 3),
(30, 15, 'Hébergement 2 - Saumur', 'Hébergement confortable situé à Saumur.', 84.94, 3),
(31, 16, 'Hébergement 1 - Angers', 'Hébergement confortable situé à Angers.', 79.13, 3),
(32, 16, 'Hébergement 2 - Angers', 'Hébergement confortable situé à Angers.', 115.65, 3),
(33, 17, 'Hébergement 1 - Ancenis', 'Hébergement confortable situé à Ancenis.', 106.66, 3),
(34, 17, 'Hébergement 2 - Ancenis', 'Hébergement confortable situé à Ancenis.', 94.10, 3),
(35, 18, 'Hébergement 1 - Nantes', 'Hébergement confortable situé à Nantes.', 53.00, 3),
(36, 18, 'Hébergement 2 - Nantes', 'Hébergement confortable situé à Nantes.', 84.06, 3),
(37, 19, 'Hébergement 1 - Saint-Nazaire', 'Hébergement confortable situé à Saint-Nazaire.', 63.32, 3),
(38, 19, 'Hébergement 2 - Saint-Nazaire', 'Hébergement confortable situé à Saint-Nazaire.', 64.65, 3),
(39, 20, 'Hébergement 1 - Montoir-de-Bretagne', 'Hébergement confortable situé à Montoir-de-Bretagne.', 115.49, 3),
(40, 20, 'Hébergement 2 - Montoir-de-Bretagne', 'Hébergement confortable situé à Montoir-de-Bretagne.', 101.88, 3),
(41, 21, 'Hébergement 1 - Decize', 'Hébergement confortable situé à Decize.', 105.36, 3),
(42, 21, 'Hébergement 2 - Decize', 'Hébergement confortable situé à Decize.', 70.15, 3);
...
INSERT INTO `bookings` (`id`, `user_id`, `start_date`, `end_date`, `created_at`, `total_price`, `promotion_code_used`) VALUES
(4, 1, '2025-08-27', '2025-08-31', '2025-08-27 23:47:57', 470.47, 'KAYAKTROPBIEN'),
(5, 1, '2025-08-29', '2025-09-03', '2025-08-28 00:15:42', 304.34, 'KAYAKTROPBIEN');
...
(3, 'Pack Aventure', 2, 'Pour les rapides du kayak', 15.90);
